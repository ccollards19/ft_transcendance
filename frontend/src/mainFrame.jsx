	...
	return (
      ...
      {props.socket.readyState === 1 &&
			<Routes>
				...
				<Route path="/match/:match" element={<Match props={props} />} />
				<Route path="/game/room/:match" element={<Game props={props} />} />
			...
			{!props.xlg &&
				<p onClick={() => document.getElementById('chat2').hidden = !document.getElementById('chat2').hidden} className='position-absolute bottom-0 end-0 me-4 mb-2 rounded-circle bg-dark-subtle d-flex justify-content-center align-items-center border border-2 border-white' style={{ width: '40px', height: '40px', zIndex: '2' }}>
