...
function French() {
    return {
        ...
        answer4 : 'Cela signifie que le serveur a rencontré un problème et que tu n\'es pas connecté. Tu n\'as alors pas accès à la plupart des pages du site. Réessaie plus tard. Le chat est dépendant du même service et est donc inutilisable également.',
