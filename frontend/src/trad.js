...
function English() {
    return {
        ...
        module5 : 'Another game is available (Tic-tac-toe)',
        module6 : 'The chat',
        ...
        answer4 : 'That means the server has encountered a problem and doesn\'t find the requested resource.',
        ...
        challengeTictactoe : 'Challenge to Tic-tac-toe',
        ...
        home21 : 'On the \'Leaderboard\' page, you will find the top [up to] 50 players, ranked by our own score system, for the game you chose to display.',
...
function French() {
    return {
        ...
        module5 : 'Un autre jeu est disponible (Tic-tac-toe)',
        module6 : 'Le chat',
        module7 : 'Tu peux jouer en ligne, tu n\'es pas obligé de partager le clavier',
        module8 : 'Tu peux visiter le site avec (presque) n\'importe quel navigateur',
        module9 : 'Le site s\'adapte à la taille de ton écran',
        module10 : 'Tu peux créer un compte, gérer ton profil, ajouter d\'autres joueurs à ta liste d\'amis et bien d\'autres options sociales',
        ...
        answer1_1 : '\'Rendre muet\'  t\'empêchera de voir les messages envoyés par l\'utilisateur dans ton chat. C\'est un statut lié à la session courante. Cela signifie que si tu recharges la page, ses messages apparaîtront de nouveau.',
        answer1_2 : '\'Bloquer\' fait également disparaître l\'utilisateur de ton chat, mais pas seulement. Il quittera ta liste d\'amis s\'il en faisait partie et ne pourra plus t\'envoyer de requêtes d\'amis ni d\'invitations à jouer. Il restera également bloqué à ta prochaine connexion ou si tu recharges la page.',
        ...
        answer4 : 'Cela signifie que le serveur a rencontré un problème et ne trouve pas la ressource que tu lui demandes.',
        question5 : 'Le mec de Jurassic Park m\'a dit que je n\'avais pas dit le mot magique. Vous vous croyez drôle ?',
        answer5 : 'Oui, évidemment. Et c\'est arrivé parce que tu as tenté d\'accéder à une url non-autorisée. Tu te crois malin ?',
        question6 : 'Un ami m\'a envoyé cette url...',
        answer6 : 'Choisis de meilleurs amis...',
        ...
        chatOut : 'Connecte-toi pour parler',
        chatIn : 'Dis un truc sympa',
        ...
        blockList2 : 'Tu n\'as bloqué personne',
        welcome1 : 'Bienvenue sur le canal ',
        welcome2 : 'Saisis /h pour obtenir de l\'aide',
        blocked : 't\'a bloqué',
        taken : 'Ce nom est déjà utilisé',
        requested : 'Tu as déjà envoyé une requête à',
        ...
        home5 : 'te connecter',
        home6 : 'si tu as déjà un compte.',
        home7 : 'Ou',
        home8 : 'créer un nouveau compte',
        home9 : '(Tu peux aussi visiter le site, et mêne jouer localement, sans compte.)',
        home10 : 'Une fois inscrit et connecté, prends le temps de compléter ton profil.',
        home11 : 'C\'est là que tu trouveras la liste de tes amis.',
        home12 : 'Ensuite, jette un oeil à la page \'Paramètres\' et configure les choses à ta convenance.',
        home13 : 'Note : Décoche \'Défiable\' si tu n\'es là que pour discuter et regarder les matches des autres.',
        home14 : 'Le jeu auquel tu choisis de jouer a une influence sur l\'affichage un peu partout sur le site.',
        home15 : 'Cela inclut l\'arrière-plan, les profils, le Top 50, la liste des tournois et ce qui sera affiché sur la page \'Jouer\' si tu choisis de jouer en ligne.',
        home16 : 'Tu trouveras un chat, sur la gauche ou affichable à l\'aide d\'un bouton en bas à droite, selon la taille de ton écran. Tu dois être connecté pour l\'utiliser.',
        home17 : 'Tu peux l\'utiliser pour discuter avec tous les utilisateurs connectés au site grâce au canal \'General\'.',
        home18 : 'Un canal unique est créé pour chaque match, pour l\'usage exclusif des joueurs et éventuels spectateurs (si tu les autorises dans les paramètres).',
        home19 : 'Chaque tournoi a également son propre canal.',
        home20 : 'Tu peux aussi cliquer sur n\'importe quel nom (sauf le tien) pour afficher un petit menu contenant des options explicites.',
        home21 : 'Sur la page \'Top 50\', tu trouveras une liste des [jusqu\'à 50] meilleurs joueurs, classé selon notre système de score, pour le jeu que tu choisiras d\'afficher.',
        home22 : 'Enfin, la page \'A propos\' te donnera des informations sur le projet.',
        home23 : 'A tout moment, tu peux afficher ce manuel en cliquant sur le bouton \'Home\' en haut à droite de l\'écran.',
        ...
        log : 'Connexion',
        sub1 : 'Si tu n\'as pas de compte, vous pouvez',
        sub2 : 'en créer un ici',
        noPage : 'Cette page n\'existe pas. Vérifie l\'adresse et réessaie.',
        ready : 'Prêt',
        cancel : 'Annuler le match',
        guest : 'Jouer en tant qu\'invité',
        letsPlayPong : 'Jouons à Pong',
        letsPlayChess : 'Jouons aux échecs',
        myProfile : 'Puisqu\'il s\'agit de ton profil, tu peux cliquer sur ton avatar, ton nom ou les titres des sections Biographie et Phrase d\'accroche pour modifier les valeurs associées.',
...
function Deutsch() {
    return {
        ...
        module5 : 'Ein weiteres Spiel ist verfügbar (Tic-tac-toe)',
        module6 : 'Der Plausch',
        ...
        answer4 : 'Das bedeutet, dass auf dem Server ein Problem aufgetreten ist und die von Ihnen angeforderte Ressource nicht gefunden werden kann.',
        ...
        challengetictactoe : 'Laden Sie ein, Tic-Tac-Toe zu spielen',
        ...
        home21 : 'Auf der Seite „Top 50“ finden Sie eine Liste der [bis zu 50] Top-Spieler, nach unserem Punktesystem klassifiziert, für das Spiel, das Sie ansehen möchten.',
