...
from tournaments.views import TournamentCreate, SetTournamentImages, GetTournament, GetAllTournaments, Subscribe, UpdateDescription, UpdateImage
...
urlpatterns = [
    ...
    path('<int:id>/updateImage/', UpdateImage.as_view()),
