...
class Chess_stats(models.Model):
    ...
    challengers = models.ManyToManyField("profiles.Profile", blank=True, related_name='chess_challengers')
    challenged = models.ManyToManyField("profiles.Profile", blank=True, related_name='chess_challenged')
    history = models.ManyToManyField('game.Match', blank=True, related_name="chess_history")
...
class Pong_stats(models.Model):
    ...
    history = models.ManyToManyField('game.Match', blank=True, related_name="pong_history")
    score = models.IntegerField(default=100)
