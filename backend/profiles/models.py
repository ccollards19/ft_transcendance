...
class Chess_stats(models.Model):
    ...
    challengers = models.ManyToManyField("profiles.Profile", null=True, related_name='chess_challengers')
    challenged = models.ManyToManyField("profiles.Profile", null=True, related_name='chess_challenged')
    history = models.ManyToManyField('game.Match', null=True, related_name="chess_history")
...
class Pong_stats(models.Model):
    ...
    wins = models.IntegerField(default=0)
    losses = models.IntegerField(default=0)
    challengers = models.ManyToManyField("profiles.Profile", null=True, related_name='pong_challengers')
    challenged = models.ManyToManyField("profiles.Profile", null=True, related_name='pong_challenged')
    history = models.ManyToManyField('game.Match', null=True, related_name="pong_history")
    score = models.IntegerField(default=100)
...
class Profile(models.Model):
    ...
    friend_requests = models.ManyToManyField("self", null=True, symmetrical=False)
    blocked = models.ManyToManyField("self", null=True)
    ...
    tournaments = models.ManyToManyField('tournaments.Tournament', null=True, related_name='tournaments')
    subscriptions = models.ManyToManyField('tournaments.Tournament', null=True, related_name='subsccriptions')
