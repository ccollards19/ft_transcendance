...
from profiles.views import GetProfile, GetMyProfile, BlockUser, ModifyProfile, Unblock, Challenge, GetProfileChat, UpdateAvatar, Leaderboard, UpdateSettings, GetChatList, GetFriendlist
