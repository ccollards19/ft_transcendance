    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('muted', models.ManyToManyField(blank=True, to='api.accounts')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rank', models.CharField(choices=[('default', 'pirate-symbol-mark-svgrepo-com.svg')])),
        ...
        migrations.AddField(
            model_name='accounts',
            name='chess_stats',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='chess_stats', to='api.chess_stats'),
        ),
        migrations.CreateModel(
            name='Pong_stats',
            fields=[
        ...
        migrations.AddField(
            model_name='accounts',
            name='pong_stats',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='pong_stats', to='api.pong_stats'),
        ),
        migrations.CreateModel(
            name='Tournament',
            fields=[
