...
function MainFrame({ profileId, setProfileId, myProfile, setMyProfile, game, setGame, tournamentId, setTournamentId }) {
    ...
    return (
            <div className="flex-grow-1 d-flex align-items-center justify-content-center" style={{backgroundImage: 'url("/images/'.concat(game, '.gif")'), backgroundSize: '100%'}}>
                ...
                <Tournaments tournamentId={tournamentId} setTournamentId={setTournamentId} />
            </div>
    )
}
